...
export default function DashboardPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-indigo-600 to-purple-700 flex items-center justify-center p-6">
      <div className="w-full max-w-4xl bg-white/95 rounded-2xl shadow-2xl p-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-gray-50 rounded-xl shadow-md p-6 hover:shadow-xl hover:-translate-y-1 transition cursor-pointer">
            ...
            <p className="text-gray-600 mb-6">
              ...
              Next.js tutorial. Includes Server Components, Suspense,
          ...
          <div className="bg-gray-50 rounded-xl shadow-md p-6 hover:shadow-xl hover:-translate-y-1 transition cursor-pointer">
            ...
            <p className="text-gray-600 mb-6">
              A full-stack task manager featuring real-time optimistic updates,
              project organization, filtering, and mobile-first design.
            </p>

            <button
              className="w-full rounded-lg bg-purple-600 py-2 text-white font-semibold hover:bg-purple-700 transition"
              onClick={() => router.push("/apps/task-manager")}
            >
              Open App
            </button>
          </div>
